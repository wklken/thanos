...
| HTTP URL/FORM parameter: | Type | Default |
|--------------------------|---------------------------------------|----------------------------------|
| `dedup` | Boolean (`1, t, T, TRUE, true, True` for "True") | Default True, but effect depends on `query.replica` configuration flag. |
|  |  |  |
...
| HTTP URL/FORM parameter: | Type | Default |
|--------------------------|---------------------------------------|----------------------------------|
| `max_source_resolution` | Integer| `step / 5` or `` |
|  |  |  |
...
| HTTP URL/FORM parameter: | Type | Default |
|--------------------------|---------------------------------------|----------------------------------|
| `partial_response` | Boolean (`1, t, T, TRUE, true, True` for "True") | `query.partial_response_enable` flag |
|  |  |  |
