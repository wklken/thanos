...
func (api *API) query(r *http.Request) (interface{}, []error, *apiError) {
	...
	enableDedup, aerr := api.parseEnableDedupParam(r)
	if aerr != nil {
		return nil, nil, aerr
	}

	enablePartialResponse, aerr := api.parsePartialResponseParam(r)
	if aerr != nil {
		return nil, nil, aerr
	}
...
func (api *API) queryRange(r *http.Request) (interface{}, []error, *apiError) {
	...
	maxSourceResolution, aerr := api.parseDownsamplingParam(r, step)
	if aerr != nil {
		return nil, nil, aerr
	}
